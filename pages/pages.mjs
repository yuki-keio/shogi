...
export const PAGES = [
  {
    ...
    ogTitle: "将棋Web",
    ogDescription:
      "【無料の将棋ゲーム】一人で遊べるAI対戦や、初心者から上級者まで楽しめる詰将棋、全国の相手や友達と遊べるオンライン対戦、将棋盤モードがブラウザで楽しめます。初心者向けのコマ解説から、有段者も楽しめる強力なAIまで搭載（最強レベルの将棋AI「やねうら王」系統とも対局可能）。登録不要でダウンロードも不要です。",
  ...
  },
  {
    ...
    description:
      "スマホ・PCがそのまま将棋盤に。1台を二人で囲んで対局したり、オンライン対戦で離れた相手と遊んだりできます。動かせるマスのハイライト、待った（戻る・進む）、棋譜の自動保存つき。二歩や打ち歩詰めも自動で判定します。登録もダウンロードも不要。",
