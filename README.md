...
- Frontend: JavaScript, HTML, CSS, WebAssembly
- Engine: YaneuraOu + SuishoPetite
...
本プロジェクトは GPLv3 ライセンスの下で公開されています。ご利用の際はライセンス条項に従ってください。

### クレジット

本アプリケーションの「AI対戦モード」における高難易度オプションの将棋AIには、以下の素晴らしいオープンソースプロジェクトを編集して利用させていただいています。
